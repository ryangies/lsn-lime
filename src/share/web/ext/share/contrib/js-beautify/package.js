...
js.extend('ext.share.contrib',function(js){function css_beautify(source_text,options){options=options||{};var indentSize=options.indent_size||4;var indentCharacter=options.indent_char||' ';if(typeof indentSize=="string")
...
if(c==='<'&&input.substring(parser_pos-1,parser_pos+3)==='<!--'){parser_pos+=3;c='<!--';while(input[parser_pos]!='\n'&&parser_pos<input_length){c+=input[parser_pos];parser_pos++;}
...
if(typeof exports!=="undefined")
exports.js_beautify=js_beautify;this.beautifyJS=js_beautify;});